...
class Frequency():
  ...
  def _by_category_groupby(self, by_category='pairs'):
    ...
    if by_category=='organisms':     return [self.c_org, self.c_out]
    elif by_category=='antibiotics': return [self.c_abx, self.c_out]
    elif by_category=='pairs':       return [self.c_org, self.c_abx, self.c_out]
    else:
